...
class SqueezeAlgo(Algorithm):
	...
	def pre_run(self):
		...
		for symbol in self.symbols:		
			...
			self.add_indicator(SMA('SMA-' + symbol, close_series, 20))
			self.add_indicator(BBandLower('BBandLower-' + symbol, close_series, 20, 2, self.i('SMA-'+symbol)))
			self.add_indicator(BBandUpper('BBandUpper-' + symbol, close_series, 20, 2, self.i('SMA-'+symbol)))
